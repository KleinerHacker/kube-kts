...
object DefaultKubeKtsCompiler : KubeKtsCompiler {
    ...
    override fun compile(kubeFile: PlainKubeKtsFile): CompiledKubeKtsFile = runBlocking {
    ...
    override fun <T> execute(file: CompiledKubeKtsFile): T = runBlocking {
