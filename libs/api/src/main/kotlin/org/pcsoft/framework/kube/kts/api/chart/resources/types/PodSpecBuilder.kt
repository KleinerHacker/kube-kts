...
class PodSpecBuilder internal constructor() {
    ...
    internal fun build(): PodSpec {
        ...
        return PodSpec(
            ...
            imagePullSecrets = imagePullSecrets?.map { LocalObjectReferenceSpecBuilder(it).build() },
            ...
            readinessGates = readinessGates?.map { ReadinessGateSpecBuilder(it).build() },
            schedulingGates = schedulingGates?.map { SchedulingGateSpecBuilder(it).build() },
            hostUsers = hostUsers,
