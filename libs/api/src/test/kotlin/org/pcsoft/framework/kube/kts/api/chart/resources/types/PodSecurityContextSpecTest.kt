...
class PodSecurityContextSpecTest {
    ...
    /**
     * Verifies that the maximal PodSecurityContextSpec definition is built into the expected spec
     * object.
     *
    ...
    /**
     * Verifies that the maximal PodSecurityContextSpec definition is serialised into the expected
     * YAML document.
     *
    ...
    /**
     * Verifies that the partially filled PodSecurityContextSpec definition is built into the
    ...
    /**
     * Verifies that the partially filled PodSecurityContextSpec definition is serialised into the
    ...
    /**
     * Verifies that the minimal PodSecurityContextSpec definition is built into the expected spec
     * object.
     *
    ...
    /**
     * Verifies that the minimal PodSecurityContextSpec definition is serialised into the expected
     * YAML document.
     *
    ...
    /**
     * Verifies that building a [PodSecurityContextSpec] fails when a value outside the allowed set
     * is used.
     *
