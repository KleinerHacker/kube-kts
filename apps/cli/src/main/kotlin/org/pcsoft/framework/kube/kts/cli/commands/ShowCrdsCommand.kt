...
/**
 * Command to show the CRDs of a chart.
 *
 * Operates on a remote/local chart; forwarded directly to `helm show crds <CHART>`.
 */
@Command(name = "crds", description = ["Show the chart's CRDs with helm"])
class ShowCrdsCommand : BaseDirectHelmCommand(), HelmArgsProvider {
