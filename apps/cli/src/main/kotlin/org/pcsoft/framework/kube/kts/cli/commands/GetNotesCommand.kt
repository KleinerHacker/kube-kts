...
/**
 * Command to download the notes for a named release.
 *
 * Operates on an already installed release; forwarded directly to `helm get notes <RELEASE>`.
 */
@Command(name = "notes", description = ["Download the notes for a named release with helm"])
class GetNotesCommand : BaseDirectHelmCommand(), HelmArgsProvider {
