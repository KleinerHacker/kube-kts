...
/**
 * Command to show all information of a chart.
 *
 * Operates on a remote/local chart; forwarded directly to `helm show all <CHART>`.
 */
@Command(name = "all", description = ["Show all information of a chart with helm"])
class ShowAllCommand : BaseDirectHelmCommand(), HelmArgsProvider {
