...
/**
 * Command to list chart repositories.
 *
 * Forwarded directly to `helm repo list`.
 */
@Command(name = "list", aliases = ["ls"], description = ["List chart repositories with helm"])
class RepoListCommand : BaseDirectHelmCommand(), HelmArgsProvider {
    @Mixin
